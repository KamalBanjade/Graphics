...
int main()
{
    ...
    // Draw lines and text
    line(230, 150, 80, 300); // completely in
    outtextxy(155, 225, "Completely In");

    line(180, 100, 30, 250); // partially in
    outtextxy(105, 175, "Partially In");

    line(130, 50, -20, 200); // completely out
    outtextxy(40, 125, "Completely Out");

    // Clip and draw lines using Cohen-Sutherland algorithm
    plotClipp(230, 150, 80, 300);
    plotClipp(180, 100, 30, 250);
    plotClipp(130, 50, -20, 200);
